  ...
  return (
    ...
    >
      ...
      <Text fontSize="md" maxWidth="640" textAlign="center">
        Parte de nuestra campaña de rescate se centra en compartir historias de vida, porque muchas veces la mascota no se elige, simplemente se encuentran
      </Text>

      <Stack paddingTop={50} maxWidth="100%">
        <Carousel cols={3} rows={1} gap={50} loop>
          {sliderImages.map((slide, idx) => {
            return <Carousel.Item key={idx} width={50}>
              {slide.image ? 
                <Image borderRadius={25} src={slide.image} height="auto" width="" />
              :
                <Flex alignItems="center" height="100%">
                <Stack direction="column">
                  <Text marginBottom={5} fontSize="4xl" fontWeight={800} textColor="black">{slide.title}</Text>
